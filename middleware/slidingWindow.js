...
// const RATE_LIMITS = {
//     guest: {
//         limit: 5,  // Max 5 requests per minute for guest
//         window: 60 * 1000,  // 1 minute in milliseconds
//     },
//     admin: {
//         limit: 20,  // Max 20 requests per minute for admin
//         window: 60 * 1000,  // 1 minute in milliseconds
//     },
// };
...
// // Rate limiter function based on sliding window algorithm
// const slidingWindowLimiter = (req, res, next) => {
//     const userRole = req.user ? req.user.role : "guest"; // Default to "guest" if no role is found
//     const { limit, window } = RATE_LIMITS[userRole]; // Get rate limit settings based on user role
